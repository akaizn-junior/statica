...
**100000** funnel items, paginated **10 per page** → `blog/1/` … `blog/10000/`, plus nested readable post pages at `blog/[page]/[slug]/` (+ `blog/` index + home) = **110002** HTML pages on disk.

```bash
statica build examples/bench-100k-pages
statica serve examples/bench-100k-pages
